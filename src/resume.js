...
export const CONTACT = {
  ...
  // NOTE: Using the /view URL (not /uc?export=download) because Google deprecated the
  // direct download URL pattern. /view works reliably from any referrer and shows a
  // preview with a download button — visitors can preview or download as they prefer.
  resume: "https://drive.google.com/file/d/1ygAcwC7dld6zppzeHq3j5-gHDRbOY7eI/view?usp=sharing",
